...
@ REM # этой строкой програмируем плис, но с таймлимитед не работает, надо использовать штатный програматор.
@ REM #%QUARTUS_ROOTDIR%\\bin64\\quartus_pgm.exe -m jtag -c USB-Blaster[USB-0] -o "p;SM_cam_tft_time_limited.sof"
...
@ "%QUARTUS_ROOTDIR%\bin64\cygwin\bin\bash.exe" --rcfile "./test_bashrc"
pause