...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=3EB33333 LPM_WIDTH=32 result
...
module  const_but_lpm_constant_k49
	( 
	result) ;
	output   [31:0]  result;
	...
	assign
		result = 32'b00111110101100110011001100110011;
endmodule //const_but_lpm_constant_k49
//VALID FILE
...
module const_but (
	...
	const_but_lpm_constant_k49	const_but_lpm_constant_k49_component (
				.result (sub_wire0));
